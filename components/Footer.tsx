      ...
      <div className="w-[80%] mx-auto grid grid-cols-2 lg:grid-cols-3 gap-[2rem] border-b-[1.4px] pb-5 border-gray-600 border-opacity-40">
        <div>
          <div className="font-logo text-white text-[18px]">
            <span className="text-[30px] md:text[40px] text-yellow-400">VK</span>
          </div>
          <h1 className="text-[14px] mt-[0.5rem] text-white opacity-70">
            Я fullstack-разработчик с опытом работы на React, Next.js и TypeScript. Разрабатываю
            надёжные серверные решения и современные интерфейсы, которые остаются быстрыми, удобными
            и отзывчивыми под высокой нагрузкой.
          </h1>
          {/* Добавляем иконки */}
          <div className="flex justify-center space-x-4 mt-4 text-white text-[25px]">
            <a href="https://t.me/vitaly_kolodchenko" target="_blank" rel="noopener noreferrer">
              <FaTelegramPlane />
            </a>
            <a href="https://wa.me/89619716339" target="_blank" rel="noopener noreferrer">
              <FaWhatsapp />
            </a>
            <a href="https://github.com/vitalyKolod" target="_blank" rel="noopener noreferrer">
              <FaGithub />
            </a>
          </div>
        </div>
        <div className="md:mx-auto">
          <h1 className="text-white font-semibold mb-[1rem] text-[19px]">Быстрые ссылки</h1>
        ...
        <div className="lg:mx-auto">
          ...
          <div className="flex items-center mt-[1rem] space-x-2">
            ...
            <p className="text-[17px] font-normal text-white opacity-75">+7-961-971-63-39</p>
          </div>
        </div>
      </div>
